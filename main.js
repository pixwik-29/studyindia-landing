...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const collegeData = {
    ...
    'andhra-telangana': [
      ...
      { value: 'fathima', label: 'Fathima Institute of Medical Sciences' },
      { value: 'gayathri-vidya', label: 'Gayathri Vidya Parishad Institute of Health Care & Medical Technology' },
      { value: 'gitam', label: 'GITAM Institute of Medical Sciences and Research' },
      { value: 'great-eastern', label: 'Great Eastern Medical School and Hospital' },
      { value: 'gsl', label: 'GSL Medical College' },
      { value: 'katuri', label: 'Katuri Medical College' },
      { value: 'konaseema', label: 'Konaseema Institute of Medical Sciences & Research Foundation' },
      { value: 'maharajah', label: 'Maharajah Institute of Medical Sciences' },
      { value: 'narayana', label: 'Narayana Medical College' },
      { value: 'nimra', label: 'Nimra Institute of Medical Sciences' },
      { value: 'nri-ims', label: 'NRI Institute of Medical Sciences' },
      { value: 'nri-mc', label: 'NRI Medical College' },
      { value: 'pes', label: 'PES Institute Of Medical Sciences and Research' },
      { value: 'santhiram', label: 'Santhiram Medical College' },
    ...
    'maharashtra': [
      { value: 'ashwini', label: 'Ashwini Rural Medical College, Hospital & Research Centre' },
      { value: 'vajpayee', label: 'Bharatratna Atal Bihari Vajpayee Medical College' },
      { value: 'walawalkar', label: 'B.K.L. Walawalkar Rural Medical College' },
      { value: 'tasgaonkar', label: 'Dr. N Y Tasgaonkar Institute of Medical Science' },
      { value: 'panjabrao', label: 'Dr. Panjabrao Alias Bhausaheb Deshmukh Memorial Medical College' },
      { value: 'gode', label: 'Dr. Rajendra Gode Medical College' },
      { value: 'ulhas-patil', label: 'Dr. Ulhas Patil Medical College & Hospital' },
      { value: 'vasantrao-pawar', label: 'Dr. Vasantrao Pawar Med. Col. Hosp. & Research Centre' },
      { value: 'vikhe-patil', label: 'Dr. Vithalrao Vikhe Patil Foundations Medical College & Hospital' },
      { value: 'iimsr-mh', label: 'Indian Institute of Medical Science & Research' },
      { value: 'somaiyya', label: 'KJ Somaiyya Medical College & Research Centre' },
      { value: 'mimer', label: 'Maharashtra Institute of Medical Education & Research' },
      { value: 'mimsr', label: 'Maharashtra Institute of Medical Sciences & Research' },
      { value: 'mgims', label: 'Mahatma Gandhi Institute of Medical Sciences' },
      { value: 'nkpsalve', label: 'N. K. P. Salve Institute of Medical Sciences and Research Centre' },
      { value: 'dy-patil-pune', label: 'Padmashree Dr. D.Y.Patil Medical College' },
      { value: 'parbhani', label: 'Parbhani Medical College' },
      { value: 'prakash', label: 'Prakash Institute of Medical Sciences & Research' },
      { value: 'kashibai-navale', label: 'Smt. Kashibai Navale Medical College and General Hospital' },
      { value: 'smbt', label: 'SMBT Institute of Medical Sciences & Research Centre' },
      { value: 'terna', label: 'Terna Medical College' },
      { value: 'vedantaa', label: 'Vedantaa Institute of Medical Sciences' },
      { value: 'acpm', label: 'ACPM Medical College' },
      { value: 'sindhudurg', label: 'Sindhudurg Medical College' },
